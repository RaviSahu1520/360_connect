...
import com.company.app.core.di.DatabaseModule_ProvideEncryptionManagerFactory;
...
import com.company.app.platform.call.CallNotificationListenerService;
import com.company.app.platform.call.VoipClient;
import com.company.app.platform.call.VoipSignalingService;
import com.company.app.platform.call.VoipSignalingService_MembersInjector;
...
import com.company.app.platform.recording.CallRecordingService;
import com.company.app.platform.recording.CallRecordingService_MembersInjector;
import com.company.app.presentation.MainActivity;
import com.company.app.presentation.MainActivity_MembersInjector;
import com.company.app.presentation.ai.AskAiViewModel;
import com.company.app.presentation.ai.AskAiViewModel_HiltModules;
import com.company.app.presentation.call.CallViewModel;
import com.company.app.presentation.call.CallViewModel_HiltModules;
import com.company.app.presentation.chat.ChatViewModel;
import com.company.app.presentation.chat.ChatViewModel_HiltModules;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectAudioCaptureManager(instance, singletonCImpl.audioCaptureManagerProvider.get());
      return instance;
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private Provider<AskAiViewModel> askAiViewModelProvider;

    private Provider<CallDetailViewModel> callDetailViewModelProvider;
    ...
    private GetCallDetailUseCase getCallDetailUseCase() {
      return new GetCallDetailUseCase(singletonCImpl.bindCallRepositoryProvider.get());
    }
    ...
    private GetCallHistoryUseCase getCallHistoryUseCase() {
      return new GetCallHistoryUseCase(singletonCImpl.bindCallRepositoryProvider.get());
    }

    private StartRecordingUseCase startRecordingUseCase() {
      return new StartRecordingUseCase(singletonCImpl.callRecordingControllerProvider.get());
    }

    private StopRecordingUseCase stopRecordingUseCase() {
      return new StopRecordingUseCase(singletonCImpl.callRecordingControllerProvider.get());
    }

    private TranscribeCallUseCase transcribeCallUseCase() {
      return new TranscribeCallUseCase(singletonCImpl.bindAIRepositoryProvider.get());
    }

    private ObserveChatMessagesUseCase observeChatMessagesUseCase() {
      return new ObserveChatMessagesUseCase(singletonCImpl.bindChatRepositoryProvider.get());
    }

    private SendMessageUseCase sendMessageUseCase() {
      return new SendMessageUseCase(singletonCImpl.bindChatRepositoryProvider.get());
    }

    private ObserveCallsUseCase observeCallsUseCase() {
      return new ObserveCallsUseCase(singletonCImpl.bindCallRepositoryProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam,
        final ViewModelLifecycle viewModelLifecycleParam) {
      this.askAiViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
      this.callDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.callHistoryViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.company.app.presentation.ai.AskAiViewModel 
          return (T) new AskAiViewModel(viewModelCImpl.ragQueryUseCase());

          case 1: // com.company.app.presentation.history.CallDetailViewModel 
          return (T) new CallDetailViewModel(viewModelCImpl.getCallDetailUseCase(), viewModelCImpl.callScopedRAGQueryUseCase());

          case 2: // com.company.app.presentation.history.CallHistoryViewModel 
          return (T) new CallHistoryViewModel(viewModelCImpl.getCallHistoryUseCase());

          case 3: // com.company.app.presentation.call.CallViewModel 
          return (T) new CallViewModel(singletonCImpl.voipClientProvider.get(), viewModelCImpl.startRecordingUseCase(), viewModelCImpl.stopRecordingUseCase(), viewModelCImpl.transcribeCallUseCase(), viewModelCImpl.ragQueryUseCase());

          case 4: // com.company.app.presentation.chat.ChatViewModel 
          return (T) new ChatViewModel(viewModelCImpl.savedStateHandle, viewModelCImpl.observeChatMessagesUseCase(), viewModelCImpl.sendMessageUseCase());
  ...
  private static final class ServiceCImpl extends App_HiltComponents.ServiceC {
    ...
    @Override
    public void injectCallNotificationListenerService(
        CallNotificationListenerService callNotificationListenerService) {
    }

    @Override
    public void injectVoipSignalingService(VoipSignalingService voipSignalingService) {
      injectVoipSignalingService2(voipSignalingService);
    }

    @Override
    public void injectCallRecordingService(CallRecordingService callRecordingService) {
      injectCallRecordingService2(callRecordingService);
    }

    @CanIgnoreReturnValue
    private VoipSignalingService injectVoipSignalingService2(VoipSignalingService instance) {
      VoipSignalingService_MembersInjector.injectSignalingClient(instance, singletonCImpl.provideSignalingClientProvider.get());
      return instance;
    }

    @CanIgnoreReturnValue
    private CallRecordingService injectCallRecordingService2(CallRecordingService instance2) {
      CallRecordingService_MembersInjector.injectAudioCaptureManager(instance2, singletonCImpl.audioCaptureManagerProvider.get());
      CallRecordingService_MembersInjector.injectCallRepository(instance2, singletonCImpl.bindCallRepositoryProvider.get());
      CallRecordingService_MembersInjector.injectDispatchers(instance2, singletonCImpl.provideDispatchersProvider.get());
      return instance2;
    }
  }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private Provider<CallRepository> bindCallRepositoryProvider;

    private Provider<AudioCaptureManager> audioCaptureManagerProvider;

    private Provider<CallRecordingController> callRecordingControllerProvider;

    private Provider<AssetExtractor> assetExtractorProvider;
    ...
    private Provider<AudioDecoder> audioDecoderProvider;

    private Provider<WhisperEngine> whisperEngineProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideEncryptionManagerProvider = DoubleCheck.provider(new SwitchingProvider<EncryptionManager>(singletonCImpl, 3));
      this.provideDispatchersProvider = DoubleCheck.provider(new SwitchingProvider<DispatcherProvider>(singletonCImpl, 4));
      this.callRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 1);
      this.bindCallRepositoryProvider = DoubleCheck.provider((Provider) callRepositoryImplProvider);
      this.audioCaptureManagerProvider = DoubleCheck.provider(new SwitchingProvider<AudioCaptureManager>(singletonCImpl, 5));
    ...
    @Override
    public CallRecordingController callRecordingController() {
      return callRecordingControllerProvider.get();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.company.app.platform.recording.CallRecordingController 
          return (T) new CallRecordingController(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.bindCallRepositoryProvider.get(), singletonCImpl.audioCaptureManagerProvider.get(), singletonCImpl.provideDispatchersProvider.get());

          case 1: // com.company.app.data.repository.CallRepositoryImpl 
          return (T) new CallRepositoryImpl(singletonCImpl.callDao(), singletonCImpl.transcriptDao(), singletonCImpl.provideEncryptionManagerProvider.get(), singletonCImpl.provideDispatchersProvider.get());

          case 2: // com.company.app.data.local.db.AppDatabase 
          return (T) DatabaseModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 3: // com.company.app.core.security.EncryptionManager 
          return (T) DatabaseModule_ProvideEncryptionManagerFactory.provideEncryptionManager();

          case 4: // com.company.app.core.common.DispatcherProvider 
          return (T) DispatcherModule_ProvideDispatchersFactory.provideDispatchers();

          case 5: // com.company.app.platform.recording.AudioCaptureManager 
